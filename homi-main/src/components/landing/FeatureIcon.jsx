...
export default function FeatureIcon({ name }) {
  return (
    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-homi-50 text-homi-600 ring-1 ring-homi-100 transition duration-300 group-hover:scale-105 group-hover:bg-homi-100">
      <svg
